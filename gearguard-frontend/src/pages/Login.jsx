...
function Login() {
    ...
    const inputClasses = "w-full pl-12 pr-4 py-3.5 bg-slate-800/80 border border-slate-700 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all autofill:bg-slate-800 autofill:text-white";
    ...
    return (
        <div className="min-h-screen flex relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            <button
                ...
                className="absolute top-6 right-6 z-50 p-3 rounded-xl bg-slate-800/50 backdrop-blur-lg border border-slate-700 hover:bg-slate-700/50 transition-all group"
            >
                {darkMode ? (
            ...
            {floatingElements.map((el, index) => (
                <motion.div
                    key={index}
                    className="absolute hidden lg:flex items-center justify-center w-16 h-16 rounded-2xl bg-slate-800/30 backdrop-blur-sm border border-slate-700/50"
            ...
            <div className="hidden lg:flex w-1/2 items-center justify-center p-12 relative">
                <div className="relative">
                    <motion.div
                        className="w-80 h-80 rounded-full bg-gradient-to-br from-primary-600/20 to-purple-600/20 blur-3xl absolute -top-20 -left-20"
                        animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }}
                        transition={{ duration: 4, repeat: Infinity }}
                    />
                    <motion.div
                        className="w-60 h-60 rounded-full bg-gradient-to-br from-cyan-600/20 to-primary-600/20 blur-3xl absolute -bottom-10 -right-10"
                    ...
                    >
                        <motion.div
                            className="w-72 h-72 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-3xl border border-slate-700 p-8 flex flex-col items-center justify-center shadow-2xl"
